...
local function MsgDoVote(msg)
    ...
    panel.Paint = function (self, w, h)
        draw.RoundedBox(6,0,0,w,h,Color(0,0,0,255*.8))
    end
...
local function MsgDoQuestion(msg)
    ...
    label:SetParent(panel)
    label:SetPos(5, 45)
    label:SetSize(panel:GetWide()-10, 40)
    label:SetText("")
    label:SetVisible(true)
    label.Paint = function (self, w, h)
        -- draw.RoundedBox(6, 10,0, panel:GetWide()-20,h,Color(0,0,0,255*.8))
        draw.DrawText(DarkRP.deLocalise(question), "defont20", panel:GetWide()/2,0, Color(255,255,255,255), 1, 1 )
    end
    ...
    ybutton.Paint = function (self, w, h)
        -- draw.RoundedBox(6, 10,0, w,h,Color(0,0,0,255*.8))
        draw.DrawText(DarkRP.getPhrase("yes"), "defont16", ybutton:GetWide()/2,0, Color(255,255,255,255), 1, 1 )
    end
    ybutton.DoClick = function()
    ...
    nbutton.Paint = function (self, w, h)
        -- draw.RoundedBox(6, 10,0, w,h,Color(0,0,0,255*.8))
        draw.DrawText(DarkRP.getPhrase("no"), "defont16", nbutton:GetWide()/2,0, Color(255,255,255,255), 1, 0 )
    end
    nbutton.DoClick = function()

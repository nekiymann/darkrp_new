...
function GM:PlayerSpawnSENT(ply, class)
    return self.Sandbox.PlayerSpawnSENT(self, ply, class) and not ply:isArrested()
end
...
function GM:PlayerSpawnSWEP(ply, class, info)
    return self.Sandbox.PlayerSpawnSWEP(self, ply, class, info) and not ply:isArrested()
end

function GM:PlayerGiveSWEP(ply, class, info)
    return self.Sandbox.PlayerGiveSWEP(self, ply, class, info) and not ply:isArrested()
end
...
function GM:PlayerSpawnVehicle(ply, model, class, info)
    return self.Sandbox.PlayerSpawnVehicle(self, ply, model, class, info) and not ply:isArrested()
end
...
function GM:PlayerSpawnNPC(ply, type, weapon)
    return self.Sandbox.PlayerSpawnNPC(self, ply, type, weapon) and not ply:isArrested()
end
